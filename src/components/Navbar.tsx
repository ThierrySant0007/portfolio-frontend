    ...
    <nav className={`nav ${scrolled ? 'scrolled' : ''} ${mobileMenuOpen ? 'menu-open' : ''}`} id="nav">
      <div className="wrapper nav-inner">
        ...
        <div className="nav-links">
          <a href="#home" onClick={(e) => scrollTo('home', e)}>Início</a>
          <a href="#projects" onClick={(e) => scrollTo('projects', e)}>Projetos</a>
          <a href="#education" onClick={(e) => scrollTo('education', e)}>Educação</a>
        </div>
        
        <a href="#contato" className="nav-contact desktop-contact" onClick={(e) => scrollTo('contato', e)}>Contato</a>
